  ...
  return (
    <div className="map" id="section4">
      ...
      <div className="scrolling-wrapper">
        ...
        <div className="card">
          <img src={process.env.PUBLIC_URL + '/images/toast.jpg'} alt="toast" style={{ width: "210px"}} />
        ...
        <div className="card">
          <img src={process.env.PUBLIC_URL + '/images/pineapple.jpg'} alt="pine" style={{ width: "150px"}} />
        ...
        <div className="card">
          <img src={process.env.PUBLIC_URL + '/images/cheese.jpg'} alt="cheese" style={{ width: "130px"}} />
        ...
        <div className="card">
          <img src={process.env.PUBLIC_URL + '/images/feta1.jpg'} alt="feta1" style={{ width: "150px"}}/>
        ...
        <div className="card">
          <img src={process.env.PUBLIC_URL + '/images/feta2.jpg'} alt="feta2" style={{ width: "150px"}} />
          <div className="container4">
            <article>DIFFICULTY</article>
            <h3>FETA AND PEACH COUSCOUS</h3>
            <p>Grab just four ingredients to make this easy, light lunch and enjoy a taste of summer. The combination of peaches, feta...</p>
